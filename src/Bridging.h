...
const bool lCrTooFar(const size_t& ulen, const std::list<std::pair<uint32_t, 
	uint32_t>>& coreList, const uint32_t& dlt);
...
const bool rCrTooFar(const size_t& ulen, const std::list<std::pair<uint32_t, 
	uint32_t>>& coreList, const uint32_t& dlt);
